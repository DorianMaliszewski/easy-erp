const routes = {
  ...
  USER_DETAIL: { path: "/users/detail/:id", title: "Détail d'un utilisateur" },
  USER_ADD: { path: "/users/form", title: "Création d'un utilisateur" },
  USER_UPDATE: { path: "/users/form/:id", title: "Modification d'un utilisateur" },
