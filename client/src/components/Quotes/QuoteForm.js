    ...
    <>
      <Grid container direction="row" alignItems="center" alignContent="center">
        <Grid item xs={12} sm={6}>
          <TextField style={{ marginTop: 20 }} label="TVA" variant="outlined" type="number" value={quoteFormContext.tva} onChange={e => quoteFormContext.changeTva(parseInt(e.target.value, 10))} />
        </Grid>
